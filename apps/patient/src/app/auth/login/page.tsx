          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-emerald-100 text-lg">
                Agende consultas, acompanhe seu tratamento e tenha acesso aos melhores especialistas em medicina canabinoide.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              <p className="text-white italic">
                "A CANNEO mudou minha qualidade de vida. O tratamento é acompanhado de perto pelos médicos."
              </p>
              <div className="flex items-center gap-3 mt-4">
                ...
                <div>
                  ...
                  <p className="text-emerald-200 text-sm">Paciente desde 2024</p>
                </div>
              </div>
            </div>
          </div>
